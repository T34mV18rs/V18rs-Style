...
#        Author: T34m V18rs          #
#     Developer : Mr. XXL            #
#  email: mrxxl.anonymous69@gmailcom #
######################################
echo -e "\e[32m[*]\e[34m WELCOME TO MR.XXL'S TOOL  \e[m "
echo
#Installing the following packages to install V18rs-Style
echo " "
echo -e "\e[32m[*]\e[34m Installing V18rs-Style \e[m "
echo
#storage permission
termux-setup-storage -y && rm -rf V18rs-Style-master
...
echo "
        ...
        WELCOME TO MR. XXL'S TOOLS_-^^TERMUX CUSTOMIZATION TOOL^^-_ OFFICIAL TOOL BY NEWB GANG V18RS
...
echo " "
echo "[*]Installing V18rs-Style please wait " |lolcat
sleep 3
...
#change directory to V18rs-Style
cd V18rs-Style
...
echo -e "\033[1;33m[*]system ok -- CHECKED BY MR. XXL \e[m "
echo -e "\033[1;33m[*]setting termux as a real hacker \e[m"
echo -e "\033[1;33m[*]Please Give Star On Our Tool In Github! \e[m "
echo FINISHED !
echo -e "\033[1;32m                                                             
﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌ \033[m "
sleep 4.0
...
echo -e "\e[32m     
    ...
    Give a star in Github and stay with us for more tools ok?
...
tput clear
tput cup 3 30
echo -e "\e[44m Thanks \e[41m For Using Our Tool \e[m"
tput cup 6 30
echo -e "\x1b[42m MR XXL's DEVELOPED AND T34M V18RS'S TOOL \x1b[m"
tput cup 9 0
...
tput cup 15 0
echo -en "\e[93m Have you liked our tool in github? (y/n)? \e[m "
read answer
...
tput cup 20 0
figlet -f slant "Please Go To The Tool Link On Github And Give A Star" |lolcat
echo " "
echo " "
#done setting up
